 ...
 * @apiError UnivRemovalFailed University removal failed
 */
 ...
 * @apiError InvalidEmailDomain not valid email domain
 */

/**
 * @apiDefine UnivAlreadyExisting
 * @apiError UnivAlreadyExisting university with given name is already existing
 */
