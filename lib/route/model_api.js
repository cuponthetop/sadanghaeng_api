 ...
 * @apiSuccess {Number} value.readCount read count
 * @apiSuccess {Number} value.likeCount number of likes for this post
 * @apiSuccess {Number} value.dislikeCount number of dislikes for this post
 ...
 * @apiSuccess {Number} value.commentCount number of comments on this post
 * @apiSuccess {Object[]} value.comments Multiple Comment Information
 * @apiSuccess {String} value.comments.cid comment unique id
 * @apiSuccess {String} value.comments.text comment text
 * @apiSuccess {String} value.comments.author author's nickname
 * @apiSuccess {Date} value.comments.written when this post was written
 * @apiSuccess {Date} value.comments.edited when this post was last edited
 * @apiSuccess {Number} value.comments.likeCount number of likes for this comment
 * @apiSuccess {Number} value.comments.dislikeCount number of dislikes for this comment
 * @apiSuccess {Number} value.comments.reportCount number of reports this post got
 * @apiSuccess {Boolean} value.comments.didVote did current user vote for this post?
 * @apiSuccess {String} value.comments.didVoteType what did current user cast? null if user haven't voted
 * @apiSuccess {Boolean} value.comments.didReport did current user report this post?
 */

/**
 * @apiDefine Comment
 * @apiSuccess {Object} value Single Comment Information
 * @apiSuccess {String} value.cid comment unique id
 * @apiSuccess {String} value.text comment text
 * @apiSuccess {String} value.author author's nickname
 * @apiSuccess {Date} value.written when this post was written
 * @apiSuccess {Date} value.edited when this post was last edited
 * @apiSuccess {Number} value.likeCount number of likes for this comment
 * @apiSuccess {Number} value.dislikeCount number of dislikes for this comment
 * @apiSuccess {Number} value.reportCount number of reports this post got
 * @apiSuccess {Boolean} value.didVote did current user vote for this post?
 * @apiSuccess {String} value.didVoteType what did current user cast? null if user haven't voted
 * @apiSuccess {Boolean} value.didReport did current user report this post?
