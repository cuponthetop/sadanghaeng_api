...
PostController.prototype.addPost = function (req, res) {
  ...
  // console.log("newPost.title is " + newPost.title);
  // console.log(newPost.title === undefined);
  // console.log(regExCheckEmptyText.test(newPost.title));
...
PostController.prototype.updateVoteOnPost = function (req, res) {
  ...
  for(var i=0 ; i<req.info.post.votes.length ; i++) {
    ...
    // if (new String(JSON.stringify(req.info.post.votes[i].uid)).valueOf() === new String("\""+newVoteUid+"\"").valueOf()) {
