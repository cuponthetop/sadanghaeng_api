(function (window) {
  ...
  View.prototype._clearSearchResultList = function() {
    $('#post_list_container').empty();
  };

  View.prototype._drawSearchResultList = function(parameter) {
  ...
  View.prototype.render = function (viewCmd, parameter) {
    ...
    var viewCommands = {
      ...
      redraw: function() {
        self._clearSearchResultList();
        self._drawSearchResultList(parameter);
      }
    };
