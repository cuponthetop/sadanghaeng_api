(function (window) {
  ...
  Controller.prototype._updateSearchResultList = function () {
    var self = this;
    self.model.getTotalPostCount({ univid: univId }, function(data) {
      self.view.render('redrawPagination', data);
    });
    self.model.getSearchResultList({ univid: univId, filter: sortFilter, page: pageNum, perPage: PER_PAGE }, function(data) {
